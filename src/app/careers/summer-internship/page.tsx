        ...
        <div className="bg-slate-900 rounded-2xl p-6 md:p-8 shadow-2xl border border-slate-800">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormInput
                id="summer_internship_name"
                name="summer_internship_name"
                label="Name"
                placeholder="Name"
                required
                value={formData.summer_internship_name}
                onChange={(e) =>
                  handleChange("summer_internship_name", e.target.value)
                }
                error={errors.summer_internship_name}
